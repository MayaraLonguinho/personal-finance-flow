...
def main():
    if len(sys.argv) == 1:
        print("Uso:")
        print("  python h_database/b_migrations/a_categorias_multiusuario.py migrate  # Aplicar migration")
        print("  python h_database/b_migrations/a_categorias_multiusuario.py rollback # Desfazer migration")
        sys.exit(1)
