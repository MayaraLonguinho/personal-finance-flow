...
class TestCategoriasPadrao(unittest.TestCase):
    ...
    @patch('src.categorias.buscar_categoria_por_nome')
    ...
    @patch('src.categorias.obter_engine')
    @patch('src.categorias.buscar_categoria_por_nome')
    @patch('src.categorias.criar_categoria')
    ...
    def test_dois_usuarios_mesma_categoria(self, mock_obter_engine):
        ...
        with patch('src.categorias.buscar_categoria_por_nome') as mock_buscar:
            def side_effect(nome, usuario_id):
                if usuario_id == 2:
            ...
            with patch('src.categorias.criar_categoria') as mock_criar:
                # Cria para usuário 1
