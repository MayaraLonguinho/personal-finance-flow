...
from b_backend.src.metrics import gerar_metricas_dashboard, buscar_ultimas_transacoes, gerar_insights
from c_generate_rpa.transform import processar_upload_csv
from c_generate_rpa.load import carregar_transacoes_mysql, limpar_transacoes_mysql, garantir_colunas_usuario
from b_backend.src.transacoes import buscar_todas_transacoes, criar_transacao, editar_transacao, excluir_transacao
from b_backend.src.metas import buscar_meta_ativa, criar_meta, atualizar_meta, excluir_meta
from b_backend.src.categorias import buscar_todas_categorias, criar_categoria, atualizar_categoria, excluir_categoria, obter_estatisticas_categoria, inicializar_categorias_padrao
from b_backend.src.financial_agent import responder_pergunta as responder_pergunta_local
from b_backend.src.ai_financial_agent import responder_pergunta_openai
from b_backend.src.relatorios import obter_relatorio
from b_backend.src.investimentos import atualizar_investimento, buscar_investimento_por_id, criar_investimento, excluir_investimento, listar_investimentos, obter_resumo_investimentos
from b_backend.src.auth import criar_usuario, buscar_usuario_por_email, verificar_senha
from b_backend.src.usuario_contexto import definir_usuario_id, limpar_usuario_id
from b_backend.src.configuracoes import (
...
app = Flask(
    __name__,
    template_folder=str(PROJECT_ROOT / "a_frontend_webclient" / "templates"),
    static_folder=str(PROJECT_ROOT / "a_frontend_webclient" / "static")
)
