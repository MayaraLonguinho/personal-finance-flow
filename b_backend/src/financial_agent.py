...
from b_backend.src.categorias import buscar_todas_categorias
from b_backend.src.investimentos import (
...
from b_backend.src.utils import formatar_data, formatar_moeda
