...
def main():
    if len(sys.argv) == 1:
        print("Uso:")
        print("  python database/migrations/002_integridade_tabelas.py migrate  # Aplicar migration")
        print("  python database/migrations/002_integridade_tabelas.py rollback # Desfazer migration")
        sys.exit(1)
