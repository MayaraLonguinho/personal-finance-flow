...
```bash
python database/migrations/001_categorias_multiusuario.py migrate
```
...
```bash
python database/migrations/001_categorias_multiusuario.py rollback
```
...
```bash
python database/migrations/002_integridade_tabelas.py migrate
```
...
```bash
python database/migrations/002_integridade_tabelas.py rollback
```
