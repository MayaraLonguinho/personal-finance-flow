...
Gera relatório com timestamp em f_test_execution/e_reports/.
"""
...
REPORTS_DIR = PROJECT_ROOT / "f_test_execution" / "e_reports"
...
def main():
    ...
    suites = {}
    suite_directories = {
        "unit": PROJECT_ROOT / "e_verify" / "a_unit",
        "integration": PROJECT_ROOT / "e_verify" / "b_integration",
        "security": PROJECT_ROOT / "e_verify" / "c_security",
    }
