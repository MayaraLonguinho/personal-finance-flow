...
from c_generate_rpa.categorization import (
    categorizar_transacao,
    normalizar_texto,
)
from c_generate_rpa.load import carregar_transacoes_mysql
from c_generate_rpa.transform import tratar_transacoes
...
class TestCategorizacaoAutomatica(unittest.TestCase):
    ...
    @patch("c_generate_rpa.transform.obter_regras_categorizacao_do_banco")
    @patch("c_generate_rpa.transform.inicializar_categorias_padrao")
