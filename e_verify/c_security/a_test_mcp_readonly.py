...
MCP_ROOT = ROOT / "d_traceability" / "c_mcp"
sys.path.insert(0, str(ROOT))

from d_traceability.c_mcp.c_allowed_resources import (  # noqa: E402
    ALLOWED_RESOURCES,
    ControlledResourceError,
    read_controlled_resource,
)
from d_traceability.c_mcp.d_readonly_service import (  # noqa: E402
    FORBIDDEN_SQL,
    QUERIES,
...
class ToolSurfaceTests(unittest.TestCase):
    def test_only_approved_tools_are_declared_without_user_id(self):
        tree = ast.parse((MCP_ROOT / "a_server.py").read_text(encoding="utf-8"))
        tools = {}
    ...
    def test_server_does_not_import_application_or_write_modules(self):
        source = (MCP_ROOT / "a_server.py").read_text(encoding="utf-8")
