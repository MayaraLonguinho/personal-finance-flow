...
from b_backend.b_src.d_categorias import inicializar_categorias_padrao, buscar_todas_categorias
...
class TestCategoriasPadrao(unittest.TestCase):
    ...
    @patch('b_backend.b_src.d_categorias.obter_engine')
    @patch('b_backend.b_src.d_categorias.buscar_categoria_por_nome')
    ...
    @patch('b_backend.b_src.d_categorias.obter_engine')
    @patch('b_backend.b_src.d_categorias.buscar_categoria_por_nome')
    @patch('b_backend.b_src.d_categorias.criar_categoria')
    ...
    def test_dois_usuarios_mesma_categoria(self, mock_obter_engine):
        ...
        with patch('b_backend.b_src.d_categorias.buscar_categoria_por_nome') as mock_buscar:
            def side_effect(nome, usuario_id):
                if usuario_id == 2:
            ...
            with patch('b_backend.b_src.d_categorias.criar_categoria') as mock_criar:
                # Cria para usuário 1
